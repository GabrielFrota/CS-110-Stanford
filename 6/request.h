 ...
 */
  ...
  /*
   * adiciona uma nova header entity ao header do request.
   */

  void adicionarHeaderEntity( const std::string& name, const std::string& value ) ;

  /*
   * retorno o parametro do header como string
   */

  const std::string& getValorHeaderComoString( const std::string& name ) ;

  /*
   *
   */

  void escreverRequestCompleto( std::ostream& os ) ;
 ...
 */
  ...
  HTTPHeader& getRequestHeader() { return requestHeader; }
